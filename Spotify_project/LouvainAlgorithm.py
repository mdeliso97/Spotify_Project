...
if __name__ == "__main__":
    ...
    G, node_dict = LabelConverter.LabelConverter(G)

    # Apply the Louvain Algorithm
    # louvain_communities = louvain_partitions_k(G, k=10)
    louvain_communities = list(LouvainScratch.louvain_algorithm(G))
    timer_elapse.checkpoint()
    ...
    partial_communities = [louvain_communities_list[0], louvain_communities_list[1]]
    edge_graph = [edge for edge in G.edges]

    # Visualization.Visualization(partial_communities, edge_graph, G)
