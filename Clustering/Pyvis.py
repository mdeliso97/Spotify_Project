import numpy as np
import pandas as pd
#from LouvainAlgorithm import *

df = pd.read_csv("nodes_with_community.csv")

communties = df.community
communties = communties.dropna()

C_List = communties.tolist()
...
'''row = community_id.iloc[1]
row1 = spotify_id.iloc[2]
print("result is: " , row1 == row)
